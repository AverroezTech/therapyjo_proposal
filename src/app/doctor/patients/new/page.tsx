...
export default function DoctorNewPatientPage() {
    ...
    return (
        <div className="page">
            <button className="back-btn" onClick={() => router.push("/doctor/patients")}>← Back to Patients</button>
            <h1>New Patient</h1>
            ...
            <div className="form-layout">
                ...
                <div className="fields-column">
                    ...
                    <div className="form-actions">
                        <button className="btn-cancel" onClick={() => router.push("/doctor/patients")}>Cancel</button>
